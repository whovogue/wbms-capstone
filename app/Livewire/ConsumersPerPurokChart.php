...
class ConsumersPerPurokChart extends ChartWidget
{
    protected static ?string $heading = 'Consumers Per Purok';
    ...
    protected function getData(): array
    {
        ...
        $userCounts = User::where('role', 'consumers')
            ->whereIn('purok', $purokList)
