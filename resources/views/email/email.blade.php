...
<body width="100%"
    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <h1 style="text-align: center;"><a href="{{ config('app.url') }}">WBMS</a></h1>
                ...
                <tr>
                    <td valign="middle" class="hero bg_white" style="padding: 20px">
                        ...
                        <p style='margin-top: 5px; margin-bottom: 5px'>
                            We hope this message finds you well. As part of our commitment to transparent and timely
                            billing, we are pleased to provide you with the details of your monthly water bill..
                        </p>
...
>>>>>>> ecc6800919e4cc485cb711403da1aaf9ed85b67a
                        ...
                        <p style='margin-top: 5px; margin-bottom: 5px'>
                            ...
                            If you have concerns regarding your bill, payments, or other details, kindly get in touch
